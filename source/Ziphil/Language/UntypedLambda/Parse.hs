...
parseTerm text = uncurry (:-) <$> parse (getTerm []) "" text

parseTerm' :: String -> Either ParseError Term
parseTerm' text = snd <$> parse (getTerm []) "" text
...
getAbsTerm :: Context -> Parser (Context, Term)
...
getAppTerm :: Context -> Parser (Context, Term)
